...
bc.. PlaceSearcher placeSearcher = new PlaceSearcherImpl(); // para todas as requisições de locais você precisará de um PlaceSearcher
...
PlacesResult result = placeSearcher.byRadius(placesApiRequest, placeRequestArgumenent);
...
bc.. CategorySearcher categorySearcher = new CategorySearcherImpl(); // para todas as requisições de categoria você precisará de um CategorySearcher
